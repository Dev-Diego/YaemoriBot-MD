...
if (!text) return conn.reply(message.chat, '🍟 *مالذي تريد البحث عنه في التيكتوك*', message, rcanal)
...
conn.reply(message.chat, '🚩 *يتم البحث عن الفيديوهات...*', message, {
...
footer: proto.Message.InteractiveMessage.Footer.create({ text: '🔎 سينكو بوت' }),
...
handler.command = ['تيك_بحث', 'tiktoks']
