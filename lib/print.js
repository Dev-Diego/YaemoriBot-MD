...
┃ ❖ ${chalk.cyan('Horario:')} ${chalk.black.bgGreen('%s')}
┃ ❖ ${chalk.green('Acción:')} ${await formatMessageStubType(m.messageStubType, name_user)}
┃ ❖ ${chalk.green('Usuario:')} ${chalk.white('%s')} / ${chalk.bgMagentaBright.bold(user.role.replace(/\*/g, ''))} / ${chalk.blue('Premium:')} ${user?.premiumTime > 0 ? '✅' : '❌'}
