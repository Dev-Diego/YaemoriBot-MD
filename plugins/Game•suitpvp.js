...
const handler = async (m, {conn, usedPrefix, text}) => {
  ...
  const caption = `🎮 Games - Pvp - Games 🎮\n\n🚩 @${m.sender.split`@`[0]} Desafia a @${m.mentionedJid[0].split`@`[0]} en un pvp de priedra, papel o tijera\n🌵 Escribe "aceptar" para aceptar el pvp\n🌵 Escribe "rechazar" para rechazar el pvp\n🐢 Respondiendo al mensaje`;
