...
await conn.sendMessage(m.chat, {text: txt1, contextInfo: { forwardingScore: 999, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterName: 'YaemoriBot 🌱', newsletterJid: "120363263466636910@newsletter", }, externalAdReply: { title: packname, body: dev, thumbnailUrl: img, sourceUrl: channel, mediaType: 1, renderLargerThumbnail: true }}}, {quoted: fkontak})
...
await conn.sendMessage(m.chat, {text: txt2, contextInfo: { forwardingScore: 999, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterName: 'YaemoriBot 🌱', newsletterJid: "120363263466636910@newsletter", }, externalAdReply: { title: packname, body: dev, thumbnailUrl: img, sourceUrl: channel, mediaType: 1, renderLargerThumbnail: true }}}, {quoted: fkontak})
