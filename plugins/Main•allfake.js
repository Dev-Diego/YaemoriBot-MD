...
global.miniMenu = 'https://qu.ax/uuYfC.jpg', 'https://qu.ax/fprhC.jpg', 'https://qu.ax/YHLEj.jpg'

global.fakeChannel = { mentionedJid: [m.sender], isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: "120363263466636910@newsletter", newsletterName: namechannel, serverMessageId: -1 }, forwardingScore: 200, externalAdReply: { title: `𝙔𝙖𝙚𝙢𝙤𝙧𝙞𝘽𝙤𝙩-𝙈𝘿 🌻✨`, body: dev, thumbnailUrl: miniMenu.getRandom(), sourceUrl: redes, mediaType: 1, renderLargerThumbnail: false }}
