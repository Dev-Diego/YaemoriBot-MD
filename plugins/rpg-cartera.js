...
await m.reply(`${who == m.sender ? `Tienes *${user.cookies} 🍪 Cookies* en tu Cartera` : `El usuario @${who.split('@')[0]} tiene *${user.cookies} 🍪 Cookies* en su Cartera`}. `, null, { mentions: [who] })}
