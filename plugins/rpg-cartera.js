...
await m.reply(`${who == m.sender ? `Tienes *${user.estrellas} 🍪 Cookies* en tu Cartera` : `El usuario @${who.split('@')[0]} tiene *${user.estrellas} 🍪 Cookies* en su Cartera`}. `, null, { mentions: [who] })}
