...
return `
${totalPages !== 1 ? `🐢 Para ir a la siguiente página escriba *${usedPrefix + command} 2*\n\n` : ''}
...
handler.command = ['personajes', 'waifup']
