...
let additionalText = ''
if (command === 'play' || command == 'mp4') {
additionalText = 'audio'
} else if (command === 'play2' || command == 'mp3') {
...
await conn.sendMessage(m.chat, { audio: { url: dl_url }, fileName: ttl + '.mp3', mimetype: 'audio/mp4' }, { quoted: m });
} catch {
...
await await conn.sendMessage(m.chat, {video: {url: dl_url}, fileName: `${ttl}.mp4`, mimetype: 'video/mp4', thumbnail: await fetch(yt.thumbnail)}, {quoted: fkontak})
} catch {

try {

let mediaa = await ytMp4(yt_play[0].url)
await await conn.sendMessage(m.chat, {video: {url: dl_url}, mimetype: 'video/mp4', fileName: ttl + `.mp4`}, {quoted: fkontak})
} catch {
...
handler.command = ['play', 'play2', 'mp4', 'mp3']
