...
let texto1 = `*乂  Y O U T U B E  -  P L A Y  乂*
...
m.react(done)
await conn.sendMessage(m.chat, { video: { url: dl_url }, fileName: `${ttl}.mp4`, mimetype: 'video/mp4', caption: `🚩 Aquí está tu video de Youtube.`, thumbnail: await fetch(yt.thumbnail) }, { quoted: m })
await m.react(done) 
} catch {
...
await m.react(done)
await conn.sendMessage(m.chat, { video: { url: mediaa.result }, fileName: `error.mp4`, caption: `🚩 Aquí está tu video de Youtube.`, thumbnail: mediaa.thumb, mimetype: 'video/mp4' }, { quoted: m })   
await m.react(done)   
} catch {
