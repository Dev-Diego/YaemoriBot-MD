...
> *Descargado el audio 🔊, aguarden un momento....*`.trim();
//yt_play[0].url

await conn.sendFile(m.chat, yt_play[0].thumbnail, 'error.jpg', texto1, m, null, rcanal);
try {
/*if (!ytplay2.all.length) return m.react(error);
...
> *Descargado su video 📽, aguarde un momento....*

> Si este comando falla usar de la seguirte manera » *#ytmp4*`.trim();
